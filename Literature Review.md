# Solar Energetic Particle Acceleration and transporation in Coronal Mass Ejections shocks using Magnetohydrohynamix
...
**Definition of Plasm**: A plasma is a *quasineutral* gas of charged and neutral particles which exhibits *collective behavior*.
